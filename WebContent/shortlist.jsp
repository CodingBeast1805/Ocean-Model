...
<!--===============================================================================================-->
    ...
    <BODY background="images3/back.jpg">
        ...
        <% 
            ...
            ResultSet resultset = 
                statement.executeQuery("select * from candidate where status>=20"); 
        %>
...
<table>
	<thead>  
		...
		<th class="cell100 column4">Qualifications</th>
		...
		<!-- <th class="cell100 column6">EXPERIENCE</th> -->
            ...
            <div class="table100-body js-pscroll">
                ...
                <td class="cell100 column4"> <%= resultset.getString(9) %></td>
                <td class="cell100 column5"> <%= resultset.getString(12) %></td>
